...
//		List<BoardVO> list = session.selectList("board.dao.BoardDAO.selectAll");
	...
	public void selectWhere() {
		/*
		// 1. 제목이 이번에는 꼭!!!!!! 이면서 글쓴이가 홍길동인 게시물 조회
		BoardVO board = new BoardVO();
		board.setTitle("이번에는 꼭!!!!!!");
		board.setWriter("홍길동");
		*/
	...
	public void selectWhere2() {
		...
		// 제목이 이번에는 꼭!!!!!!, 작성자 홍길동인 게시물 조회
		
		Map<String, String> board = new HashMap<>();
		board.put("title", "이번에는 꼭!!!!!!");
	...
	public void selectWhere3() {
		...
		//map형태로 날아오는 것은 컬럼명이 key, 들어있는 데이터가 value
